<div class="support-chat-container">
      ...
      <div class="card-body chat p-0">
        <div class="d-flex flex-column-reverse scrollbar h-100 p-3">
          ...
          <div class="text-center mt-auto">
            <div class="avatar avatar-3xl status-online"><img class="rounded-circle border border-3 border-white" src={{ Vite::asset('resources/img/team/30.webp')}} alt="" /></div>
  ...
  <button class="btn btn-support-chat p-0 border border-translucent"><span class="fs-8 btn-text text-primary text-nowrap">Chat demo</span>
    <div class="active-icon position-absolute position-sm-relative mt-n4 ms-n6 mt-sm-0 ms-sm-2"><span class="active-icon-bg"></span></div><span class="fa-solid fa-headset text-primary fs-8 d-sm-none"></span><span class="fa-solid fa-chevron-down text-primary fs-7"></span>
  </button>
</div>
